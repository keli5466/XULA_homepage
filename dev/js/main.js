 ...
 * Build: `lodash category="object,collection,array,function,lang" -d -o source/js/libs/lodash.js`
...
$('.slider').each(function slider() {							// For every slider
	...
	function move(newIndex) {					// Creates the slide from old to new one
		var animateLeft, slideLeft;			// Declare variable
	...
	function advance() {										 // Used to set
		...
		}, 10000);															// Milliseconds timer will wait
	}
